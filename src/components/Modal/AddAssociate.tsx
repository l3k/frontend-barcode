...
import { createAssociate } from '../../services/associate';
...
const AddAssociate: React.FC<AddAssociateProps> = ({ showModal, onCloseModal, handleSave }) => {
  ...
  async function newAssociate(event: FormEvent<HTMLFormElement>) {
    event.preventDefault()
    try {
      await createAssociate(name, email, phone, document, token)
      onCloseModal()
      setName('')
      setPhone('')
      setDocument('')
        ...
        <div className="overflow-y-auto overflow-x-hidden justify-center items-center w-full max-h-full">
          <div className="relative w-full max-h-full">
            ...
            <div className="relative dark:bg-boxdark rounded-lg shadow">
              ...
              <form className="p-4 md:p-5" onSubmit={newAssociate}>
